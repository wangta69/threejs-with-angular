...
export class GlftLoaderComponent implements OnInit, OnDestroy, AfterViewInit { // , AfterViewInit
  ...
  private gltfloader() {
    ...
    loader.load('/assets/F-16D_1.gltf',  ( gltf ) => {
  ...
  // 카메라 관련 정의 시작
  private setCamera() {
    const fov = 75; // [Float]  Camera frustum vertical field of view, from bottom to top of view, in degrees. Default is 50.
    ...
    this.camera.position.z = 9; // 근/원 거리
